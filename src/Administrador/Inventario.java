...
public class Inventario extends javax.swing.JPanel {
    ...
    private void AgregarLabelMouseClicked(java.awt.event.MouseEvent evt) {                                          
    ...
    private void QuitarLabelMouseClicked(java.awt.event.MouseEvent evt) {                                         
        mt.removeRow(jTable1.getSelectedRow());
    }                                        

    private void EditarTXTMouseClicked(java.awt.event.MouseEvent evt) {                                       
        if (Codigo.getText().equals("") || Nombre.getText().equals("") || Valor.getText().equals("") || Cantidad.getText().equals("")) {
            javax.swing.JOptionPane.showMessageDialog(this, "No ha ingresado algun dato, por favor verifique y vuelva a intentarlo");
        }
        else {
            mt.setValueAt(Codigo.getText(), jTable1.getSelectedRow(), 0);
            mt.setValueAt(Nombre.getText(), jTable1.getSelectedRow(), 1);
            mt.setValueAt(Double.valueOf(Valor.getText()), jTable1.getSelectedRow(), 2);
            mt.setValueAt(Integer.valueOf(Cantidad.getText()), jTable1.getSelectedRow(), 3);
            Codigo.setText("");
            Nombre.setText("");
            Valor.setText("");
            Cantidad.setText("");  
    ...
    private void AgregarLabelMouseEntered(java.awt.event.MouseEvent evt) {                                          
        AñadirJtable.setBackground(new Color(30, 30, 30));
    }                                         

    private void AgregarLabelMouseExited(java.awt.event.MouseEvent evt) {                                         
        AñadirJtable.setBackground(new Color(76, 76, 76));
    }                                        

    private void QuitarLabelMouseEntered(java.awt.event.MouseEvent evt) {                                         
        EliminaJtable.setBackground(new Color(30, 30, 30));
    }                                        

    private void QuitarLabelMouseExited(java.awt.event.MouseEvent evt) {                                        
        EliminaJtable.setBackground(new Color(76, 76, 76));
    }                                       

    private void EditarTXTMouseEntered(java.awt.event.MouseEvent evt) {                                       
        EditarJtable.setBackground(new Color(30, 30, 30));
    }                                      

    private void EditarTXTMouseExited(java.awt.event.MouseEvent evt) {                                      
